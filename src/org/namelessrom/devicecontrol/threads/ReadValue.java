 ...
 */
public class ReadValue extends Thread implements DeviceConstants {
    ...
    public ReadValue(String filename, Handler handler) {
        this(filename, handler, false);
    }

    public ReadValue(String filename, Handler handler, boolean needsNewline) {
        mCmd = "cat " + filename;
        mHandler = handler;
    ...
    public void run() {
        ...
        try {
            ...
            CommandCapture cmdCap = new CommandCapture(40, false, mCmd) {
                @Override
