...
public class PerformanceGeneralFragment extends PreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mLcdPowerReduce = (SwitchPreference) findPreference(KEY_CPU_LCD_POWER_REDUCE);
    ...
    public boolean onPreferenceChange(Preference preference, Object o) {
        ...
        if (preference == mLcdPowerReduce) {
            ...
            PreferenceHelper.setBoolean(KEY_CPU_LCD_POWER_REDUCE, value);
            changed = true;
        }
    ...
    public static void restore() {
        if (sLcdPowerReduce) {
            Utils.writeValue(sLcdPowerReduceFile,
                    (PreferenceHelper.getBoolean(KEY_CPU_LCD_POWER_REDUCE, false) ? "1" : "0"));
        }
    }
