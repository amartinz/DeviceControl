...
import org.namelessrom.devicecontrol.fragments.dialogs.HelpDialog;
...
public class InformationFragment extends AttachFragment {
    ...
    private List<Fragment> getFragments() {
        ...
        tmpList.add(HelpDialog.newInstance(0));
        tmpList.add(HelpDialog.newInstance(1));
        tmpList.add(HelpDialog.newInstance(2));
        return tmpList;
    }
