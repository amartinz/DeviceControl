...
public class Application extends android.app.Application implements DeviceConstants {
    ...
    @Override public void onCreate() {
        ...
        Logger.setEnabled(PreferenceHelper.getBoolean(DeviceConstants.EXTENSIVE_LOGGING, false));
        ...
        final boolean showLauncher =
                PreferenceHelper.getBoolean(DeviceConstants.SHOW_LAUNCHER, true) || !Application.IS_NAMELESS;
