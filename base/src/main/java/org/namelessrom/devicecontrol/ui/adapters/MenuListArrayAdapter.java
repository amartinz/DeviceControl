...
public class MenuListArrayAdapter extends BaseAdapter {
    ...
    public MenuListArrayAdapter(final Context context, final int layoutResourceId,
            final String[] entries, final int[] titles, final int[] icons) {
        mContext = context;
    ...
    @Override public int getCount() { return mEntries.length; }

    @Override public Object getItem(final int position) { return mEntries[position]; }
