...
public class SoundControlHelper {
    ...
    public boolean getHeadphone() {
        return TextUtils.isEmpty(Utils.readOneLine(HEADPHONE_GAIN));
    }
    ...
    public boolean getSpeaker() {
        return TextUtils.isEmpty(Utils.readOneLine(SPEAKER_GAIN));
    }
    ...
    public boolean getMicrophoneHandset() {
        return TextUtils.isEmpty(Utils.readOneLine(MIC_GAIN));
    }
    ...
    public boolean getMicrophoneCam() {
        return TextUtils.isEmpty(Utils.readOneLine(CAM_GAIN));
    }
    ...
    public boolean getHeadphonePa() {
        return !TextUtils.isEmpty(Utils.readOneLine(HEADPHONE_PA_GAIN));
    }
