...
public class BootupService extends IntentService implements DeviceConstants {
    ...
    private class BootTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            final DeviceConfiguration configuration = DeviceConfiguration.get(BootupService.this);
            ...
            // Tasker
            //==================================================================================
            if (TaskerConfiguration.get(BootupService.this).fstrimEnabled) {
                Logger.v(this, "Scheduling Tasker - FSTRIM");
                AlarmHelper.setAlarmFstrim(mContext,
                        TaskerConfiguration.get(BootupService.this).fstrimInterval);
            }
