...
public class TaskerWizardModel extends AbstractWizardModel implements PerformanceConstants {
    ...
    private String[] getBooleanValues() { return new String[]{"0", "1"}; }
