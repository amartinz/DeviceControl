...
public class SeekBarPreference extends Preference implements OnSeekBarChangeListener {
    ...
    private static final String DC            =
            "http://schemas.android.com/apk/lib/org.namelessrom.devicecontrol";
    ...
    private void setValuesFromXml(AttributeSet attrs) {
        ...
        String units = getAttributeStringValue(attrs, DC, "units", "");
        mUnitsRight = getAttributeStringValue(attrs, DC, "unitsRight", units);
        try {
            String newInterval = attrs.getAttributeValue(DC, "interval");
    ...
    protected View onCreateView(ViewGroup parent) {
        ...
        try {
            ...
            layout =
                    (RelativeLayout) mInflater.inflate(R.layout.seek_bar_preference, parent, false);
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        if (newValue > mMaxValue) { newValue = mMaxValue; } else if (newValue < mMinValue) {
            newValue = mMinValue;
        } else if (mInterval != 1 &&
                newValue % mInterval != 0) {
