...
public class GpuGovAction extends BaseAction {
    ...
    @Override public void triggerAction() {
        ...
        setBootup(GpuUtils.get().getGpuGovPath());

        RootShell.fireAndForget(Utils.getWriteCommand(GpuUtils.get().getGpuGovPath(), value));
    }
