...
public class GeomagneticRotationVectorSensor extends BaseSensor {
    public static final int TYPE = Sensor.TYPE_GEOMAGNETIC_ROTATION_VECTOR;
    ...
    public GeomagneticRotationVectorSensor(final Context context) {
        super(context);
        ...
        getTitle().setText(R.string.sensor_geomagnetic_rotation_vector);
