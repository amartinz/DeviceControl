...
public interface DeviceConstants {
    ...
    public static final int ID_KSM = ID_PERFORMANCE_EXTRA + 1000;
    public static final int ID_UKSM = ID_PERFORMANCE_EXTRA + 1100;
    public static final int ID_VOLTAGE = ID_PERFORMANCE_EXTRA + 1200;
    public static final int ID_ENTROPY = ID_PERFORMANCE_EXTRA + 1300;
    public static final int ID_IOSCHED_TUNING = ID_PERFORMANCE_EXTRA + 1400;
