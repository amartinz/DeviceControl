...
public class MagneticFieldUncalibratedSensor extends BaseSensor {
    public static final int TYPE = Sensor.TYPE_MAGNETIC_FIELD_UNCALIBRATED;
    ...
    public MagneticFieldUncalibratedSensor(final Context context) {
        super(context);
        ...
        setup(R.string.sensor_magnetic_field_uncalibrated);
