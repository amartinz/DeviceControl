...
public class MaterialTabHost extends RelativeLayout implements View.OnClickListener {
    ...
    public MaterialTabHost(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            TypedArray a = context.getTheme()
                    .obtainStyledAttributes(attrs, R.styleable.MaterialTabHost, 0, 0);
    ...
    private void scrollTo(int position) {
        ...
        for (int i = 0; i < position; i++) {
            ...
            if (width == 0) {
                ...
                } else { width = (int) (tabs.get(i).getTabMinWidth() + (48 * density)); }
            }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (this.getWidth() != 0 && tabs.size() != 0) { notifyDataSetChanged(); }
    }
    ...
    public void notifyDataSetChanged() {
        ...
        if (!scrollable) { // not scrollable tabs
            ...
            if (!isTablet) {
                for (int i = 0; i < tabs.size(); i++) {
                    ...
                    int tabWidth = (int) (tab.getTabMinWidth() +
                            (24 * density)); // 12dp + text/icon width + 12dp
                    ...
                    params = new LinearLayout.LayoutParams(tabWidth,
                            HorizontalScrollView.LayoutParams.MATCH_PARENT);
                ...
                for (int i = 0; i < tabs.size(); i++) {
                    ...
                    int tabWidth = (int) (tab.getTabMinWidth() +
                            (48 * density)); // 24dp + text/icon width + 24dp
        ...
        if (isTablet && scrollable) {
            ...
            final ImageButton left = new ImageButton(this.getContext());
            ...
            final ImageButton right = new ImageButton(this.getContext());
