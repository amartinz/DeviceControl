...
public class IabHelper {
     ...
     *                        your app's base64-encoded
     *                        public key in your application's page on Google Play Developer
     *                        Console. Note that this
    ...
    public interface OnIabPurchaseFinishedListener {
         ...
         * the sku and extraData parameters may or may not be null,
         * depending on how far the purchase
         * process went.
         *
     ...
     * @param extraData   Extra data (developer payload), which will be returned with the
     *                    purchase data
     *                    when the purchase completes. This extra data will be permanently bound
     *                    to that purchase
    ...
    public Inventory queryInventory(boolean querySkuDetails, List<String> moreItemSkus,
        ...
        try {
            ...
            throw new IabException(IABHELPER_BAD_RESPONSE, "Error parsing JSON response while " +
                    "refreshing inventory.", e);
        }
    }
