...
public class SlidingFragmentActivity extends FragmentActivity implements SlidingActivityBase {
    ...
    /* (non-Javadoc)
     * @see com.jeremyfeinstein.slidingmenu.lib.app.SlidingActivityBase#setBehindContentView
     * (android.view.View)
     */
    ...
    /* (non-Javadoc)
     * @see com.jeremyfeinstein.slidingmenu.lib.app
     * .SlidingActivityBase#setSlidingActionBarEnabled(boolean)
     */
