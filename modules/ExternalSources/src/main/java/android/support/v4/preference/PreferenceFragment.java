...
public abstract class PreferenceFragment extends Fragment implements
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        PreferenceManagerCompat
                .dispatchActivityResult(mPreferenceManager, requestCode, resultCode, data);
    }
    ...
    public void addPreferencesFromIntent(Intent intent) {
        ...
        setPreferenceScreen(PreferenceManagerCompat
                .inflateFromIntent(mPreferenceManager, intent, getPreferenceScreen()));
    }
    ...
    public void addPreferencesFromResource(int preferencesResId) {
        ...
        setPreferenceScreen(
                PreferenceManagerCompat.inflateFromResource(mPreferenceManager, getActivity(),
