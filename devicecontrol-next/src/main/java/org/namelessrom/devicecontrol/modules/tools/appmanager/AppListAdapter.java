...
public class AppListAdapter extends RecyclerView.Adapter<AppListAdapter.ViewHolder> {
    ...
    public final class ViewHolder extends RecyclerView.ViewHolder implements CompoundButton.OnCheckedChangeListener, View.OnLongClickListener {
        ...
        public ViewHolder(final View v) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                container.setOnTouchListener((v1, event) -> {
                    v1.getBackground().setHotspot(event.getX(), event.getY());
                    return false;
                });
            }
        ...
        public void bind(final AppItem appItem) {
            ...
            int color = ThemeHelper.with(mActivity).isDarkTheme() ? Color.WHITE : Color.BLACK;
            ...
            boolean isWhitelisted = Constants.APP_MANAGER_PACKAGE_WHITE_LIST.contains(appItem.getPackageName());
            appSelector.setEnabled(!isWhitelisted);
                    ...
                    case R.id.sheet_uninstall: {
                        ...
                        new AlertDialog.Builder(mActivity)
                                ...
                                .setPositiveButton(android.R.string.yes,
                                        (dialog, which) -> { appItem.uninstall(mActivity, mUninstallListener); })
                                .show();
                        break;
                    }
                }
    ...
    @Override public ViewHolder onCreateViewHolder(final ViewGroup parent, final int type) {
        ...
        final CardView cardView = (CardView) LayoutInflater.from(context).inflate(R.layout.card_app_item, parent, false);
        cardView.setCardBackgroundColor(ThemeHelper.with(context).getCardBackgroundColor());
